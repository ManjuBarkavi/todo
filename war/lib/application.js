  ...
  TaskApp = (function() {
    ...
    TaskApp.prototype.renderCount = function() {
      ...
      if(active === 0 && inactive === 0){
    	  TodoApp.push('showNotification',{ // Send showNotification request.
    		'icon'   : null,                                          
    		'title'  : "Todo app",                          
    		'message': "Hurrah! all the tasks were done."
    	  });
      }
      TodoApp.push('showCount',{'count':active});
